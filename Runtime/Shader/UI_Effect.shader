...
Shader "Hidden/UI_Effect_Variant" {
    Properties {
        ...
        //[Toggle] _Effect1UseRotate("Effect1 Use Rotate", Int) = 0
        //[Toggle] _Effect1UseScroll("Effect1 Use Scroll", Int) = 0
        //[Toggle] _Effect1UseGlow("Effect1 Use Glow", Int) = 0
        //[Toggle] _Effect1UniformUV("Effect1 Uniform UV", Int) = 0
        ...
        //[Toggle] _Effect2UseRotate("Effect2 Use Rotate", Int) = 0
        //[Toggle] _Effect2UseScroll("Effect2 Use Scroll", Int) = 0
        //[Toggle] _Effect2UseGlow("Effect2 Use Glow", Int) = 0
        //[Toggle] _Effect2UniformUV("Effect2 Uniform UV", Int) = 0
        ...
        //[Toggle] _Effect3UseRotate("Effect3 Use Rotate", Int) = 0
        //[Toggle] _Effect3UseScroll("Effect3 Use Scroll", Int) = 0
        //[Toggle] _Effect3UseGlow("Effect3 Use Glow", Int) = 0
        //[Toggle] _Effect3UniformUV("Effect3 Uniform UV", Int) = 0
        ...
        //[Toggle] _Effect4UseRotate("Effect4 Use Rotate", Int) = 0
        //[Toggle] _Effect4UseScroll("Effect4 Use Scroll", Int) = 0
        //[Toggle] _Effect4UseGlow("Effect4 Use Glow", Int) = 0
        //[Toggle] _Effect4UniformUV("Effect4 Uniform UV", Int) = 0
        ...
        //[Toggle] _Effect5UseRotate("Effect5 Use Rotate", Int) = 0
        //[Toggle] _Effect5UseScroll("Effect5 Use Scroll", Int) = 0
        //[Toggle] _Effect5UseGlow("Effect5 Use Glow", Int) = 0
        //[Toggle] _Effect5UniformUV("Effect5 Uniform UV", Int) = 0
        ...
        //[Toggle] _Effect6UseRotate("Effect6 Use Rotate", Int) = 0
        //[Toggle] _Effect6UseScroll("Effect6 Use Scroll", Int) = 0
        //[Toggle] _Effect6UseGlow("Effect6 Use Glow", Int) = 0
        //[Toggle] _Effect6UniformUV("Effect6 Uniform UV", Int) = 0
    ...
    SubShader {
        ...
        Pass 
        {
            ...
            #pragma shader_feature_local _BASESPRITEGRAYSCALELUMINANCEMASK_ON
            #pragma shader_feature_local _BASESPRITEBRIGHTNESS_ON
            #pragma shader_feature_local _BASESPRITEBRIGHTNESSLUMINANCEMASK_ON
            #pragma shader_feature_local _BASETINTCOLOR_ON
            ...
            #pragma shader_feature_local _EFFECT1USEGLOW_ON
            #pragma shader_feature_local _EFFECT1BLENDMASK_ON
            #pragma shader_feature_local _EFFECT1ALPHABLEND_ON
            #pragma shader_feature_local _EFFECT1UNIFORMUV_ON
            #pragma shader_feature_local _EFFECT1USEALPHA_ON
            ...
            #pragma shader_feature_local _EFFECT1USEDISTORTMASK_ON
            #pragma shader_feature_local _EFFECT1USEMASKUV_ON
            #pragma shader_feature_local _EFFECT1USETIMERMASK_ON
            #pragma shader_feature_local _EFFECT1USETIMEROFFSETMASK_ON
            #pragma shader_feature_local _EFFECT1USETIMERMASKBASEUV_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT1USELUMINANCEMASK_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT2USEGLOW_ON
            #pragma shader_feature_local _EFFECT2BLENDMASK_ON
            #pragma shader_feature_local _EFFECT2ALPHABLEND_ON
            #pragma shader_feature_local _EFFECT2UNIFORMUV_ON
            #pragma shader_feature_local _EFFECT2USEALPHA_ON
            ...
            #pragma shader_feature_local _EFFECT2USEDISTORTMASK_ON
            #pragma shader_feature_local _EFFECT2USEMASKUV_ON
            #pragma shader_feature_local _EFFECT2USETIMERMASK_ON
            #pragma shader_feature_local _EFFECT2USETIMEROFFSETMASK_ON
            #pragma shader_feature_local _EFFECT2USETIMERMASKBASEUV_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT2USELUMINANCEMASK_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT3USEGLOW_ON
            #pragma shader_feature_local _EFFECT3BLENDMASK_ON
            #pragma shader_feature_local _EFFECT3ALPHABLEND_ON
            #pragma shader_feature_local _EFFECT3UNIFORMUV_ON
            #pragma shader_feature_local _EFFECT3USEALPHA_ON
            ...
            #pragma shader_feature_local _EFFECT3USEDISTORTMASK_ON
            #pragma shader_feature_local _EFFECT3USEMASKUV_ON
            #pragma shader_feature_local _EFFECT3USETIMERMASK_ON
            #pragma shader_feature_local _EFFECT3USETIMEROFFSETMASK_ON
            #pragma shader_feature_local _EFFECT3USETIMERMASKBASEUV_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT3USELUMINANCEMASK_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT4USEGLOW_ON
            #pragma shader_feature_local _EFFECT4BLENDMASK_ON
            #pragma shader_feature_local _EFFECT4ALPHABLEND_ON
            #pragma shader_feature_local _EFFECT4UNIFORMUV_ON
            #pragma shader_feature_local _EFFECT4USEALPHA_ON
            ...
            #pragma shader_feature_local _EFFECT4USEDISTORTMASK_ON
            #pragma shader_feature_local _EFFECT4USEMASKUV_ON
            #pragma shader_feature_local _EFFECT4USETIMERMASK_ON
            #pragma shader_feature_local _EFFECT4USETIMEROFFSETMASK_ON
            #pragma shader_feature_local _EFFECT4USETIMERMASKBASEUV_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT4USELUMINANCEMASK_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT5USEGLOW_ON
            #pragma shader_feature_local _EFFECT5BLENDMASK_ON
            #pragma shader_feature_local _EFFECT5ALPHABLEND_ON
            #pragma shader_feature_local _EFFECT5UNIFORMUV_ON
            #pragma shader_feature_local _EFFECT5USEALPHA_ON
            ...
            #pragma shader_feature_local _EFFECT5USEDISTORTMASK_ON
            #pragma shader_feature_local _EFFECT5USEMASKUV_ON
            #pragma shader_feature_local _EFFECT5USETIMERMASK_ON
            #pragma shader_feature_local _EFFECT5USETIMEROFFSETMASK_ON
            #pragma shader_feature_local _EFFECT5USETIMERMASKBASEUV_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT5USELUMINANCEMASK_ON
            #endif
            ...
            #pragma shader_feature_local _EFFECT6USEGLOW_ON
            //#pragma shader_feature_local _EFFECT6BLENDMASK_ON
            //#pragma shader_feature_local _EFFECT6ALPHABLEND_ON
            //#pragma shader_feature_local _EFFECT6UNIFORMUV_ON
            //#pragma shader_feature_local _EFFECT6USEALPHA_ON
            ...
            //#pragma shader_feature_local _EFFECT6USEDISTORTMASK_ON
            //#pragma shader_feature_local _EFFECT6USEMASKUV_ON
            #pragma shader_feature_local _EFFECT6USETIMERMASK_ON
            #pragma shader_feature_local _EFFECT6USETIMEROFFSETMASK_ON
            //#pragma shader_feature_local _EFFECT6USETIMERMASKBASEUV_ON
            #endif
            ...
            //#pragma shader_feature_local _EFFECT6USELUMINANCEMASK_ON
            #endif
            ...
            struct VertexOutput {
                ...
                #if _EFFECT1USEGLOW_ON || _EFFECT2USEGLOW_ON || _EFFECT3USEGLOW_ON || _EFFECT4USEGLOW_ON
                fixed4 Glowcolor1 : COLOR1;
                #endif
                #if _EFFECT5USEGLOW_ON || _EFFECT6USEGLOW_ON
            ...
            //#if _BASESPRITEGRAYSCALELUMINANCEMASK_ON || _BASESPRITEBRIGHTNESSLUMINANCEMASK_ON || _EFFECT1USELUMINANCEMASK_ON || _EFFECT2USELUMINANCEMASK_ON || _EFFECT3USELUMINANCEMASK_ON || _EFFECT4USELUMINANCEMASK_ON || _EFFECT5USELUMINANCEMASK_ON || _EFFECT6USELUMINANCEMASK_ON
            float _LuminanceMaskThresholdMin;
            float _LuminanceMaskThresholdMax;
            //#endif

            #if _BASESPRITEGRAYSCALE_ON
            float _BaseGrayscaleValue;
            #endif

            #if _BASESPRITEBRIGHTNESS_ON
            float _BaseBrightnessValue;
            #endif

            #if _BASETINTCOLOR_ON
            ...
            //#endif
                ...
                #if defined(_EFFECT1USEMASK_ON) || defined(_EFFECT1USEDISTORTMASK_ON)
                    #if defined(_EFFECT1USEMASK_ON)
                    uniform sampler2D _Effect1Mask; uniform float4 _Effect1Mask_ST;
                    #endif
                    #if _EFFECT1USEDISTORTMASK_ON
                ...
                #if defined(_EFFECT2USEMASK_ON) || defined(_EFFECT2USEDISTORTMASK_ON)
                    #if defined(_EFFECT2USEMASK_ON)
                    uniform sampler2D _Effect2Mask; uniform float4 _Effect2Mask_ST;
                    #endif
                    #if _EFFECT2USEDISTORTMASK_ON
                ...
                #if defined(_EFFECT3USEMASK_ON) || defined(_EFFECT3USEDISTORTMASK_ON)
                    #if defined(_EFFECT3USEMASK_ON)
                    uniform sampler2D _Effect3Mask; uniform float4 _Effect3Mask_ST;
                    #endif
                    #if _EFFECT3USEDISTORTMASK_ON
                ...
                #if defined(_EFFECT4USEMASK_ON) || defined(_EFFECT4USEDISTORTMASK_ON)
                    #if defined(_EFFECT4USEMASK_ON)
                    uniform sampler2D _Effect4Mask; uniform float4 _Effect4Mask_ST;
                    #endif
                    #if _EFFECT4USEDISTORTMASK_ON
                ...
                #if defined(_EFFECT5USEMASK_ON) || defined(_EFFECT5USEDISTORTMASK_ON)
                    #if defined(_EFFECT5USEMASK_ON)
                    uniform sampler2D _Effect5Mask; uniform float4 _Effect5Mask_ST;
                    #endif
                    #if _EFFECT5USEDISTORTMASK_ON
                ...
                #if defined(_EFFECT6USEMASK_ON)// || defined(_EFFECT6USEDISTORTMASK_ON)
                    #if defined(_EFFECT6USEMASK_ON)
                    uniform sampler2D _Effect6Mask; uniform float4 _Effect6Mask_ST;
                    #endif
                    //#if _EFFECT6USEDISTORTMASK_ON
            ...
            VertexOutput vert (VertexInput v) {
                ...
                //Effect 1
                    ...
                    #if _EFFECT1UNIFORMUV_ON
                    o.uv0.zw = ScaleUV(v.texcoord1.xy, 1, rectAspect);
                    #else
                    o.uv0.zw = ScaleUV(v.texcoord1.xy,1);
                    #endif
                ...
                //Effect 2
                    ...
                    #if _EFFECT2UNIFORMUV_ON
                    o.uv1.xy = ScaleUV(v.texcoord1.xy, 1, rectAspect);
                    #else
                    o.uv1.xy = ScaleUV(v.texcoord1.xy,1);
                    #endif
                ...
                //Effect 3
                    ...
                    #if _EFFECT3UNIFORMUV_ON
                    o.uv1.zw = ScaleUV(v.texcoord1.xy, 1, rectAspect);
                    #else
                    o.uv1.zw = ScaleUV(v.texcoord1.xy,1);
                    #endif
                ...
                //Effect 4
                    ...
                    #if _EFFECT4UNIFORMUV_ON
                    o.uv2.xy = ScaleUV(v.texcoord1.xy, 1, rectAspect);
                    #else
                    o.uv2.xy = ScaleUV(v.texcoord1.xy,1);
                    #endif
                ...
                //Effect 5
                    ...
                    #if _EFFECT5UNIFORMUV_ON
                    o.uv2.zw = ScaleUV(v.texcoord1.xy, 1, rectAspect);
                    #else
                    o.uv2.zw = ScaleUV(v.texcoord1.xy,1);
                    #endif
                ...
                //Effect 6
                    ...
                    //#if _EFFECT6UNIFORMUV_ON
                    //o.uv3.xy = ScaleUV(v.texcoord1.xy, 1, rectAspect);
                    //#else
                    //o.uv3.xy = ScaleUV(v.texcoord1.xy,1);
                    //#endif
            ...
            fixed4 frag(VertexOutput i) : COLOR{
                ...
                #else
                    #if _BASESPRITEGRAYSCALE_ON
                        #if _BASESPRITEGRAYSCALELUMINANCEMASK_ON
                        _Mask_var.rgb = lerp(_Mask_var.rgb,lerp(_Mask_var.rgb, dot(_Mask_var.rgb, float3(0.299, 0.587, 0.114)), _BaseGrayscaleValue), _SpriteLuminanceMask);
                        #else
                        _Mask_var.rgb = lerp(_Mask_var.rgb, dot(_Mask_var.rgb,float3(0.299,0.587,0.114)),_BaseGrayscaleValue);
                        #endif
                    #endif

                    #if _BASESPRITEBRIGHTNESS_ON
                        #if _BASESPRITEBRIGHTNESSLUMINANCEMASK_ON
                        _Mask_var.rgb = lerp(_Mask_var.rgb,saturate(_Mask_var.rgb * _BaseBrightnessValue), _SpriteLuminanceMask);
                        #else
                        _Mask_var.rgb = saturate(_Mask_var.rgb * _BaseBrightnessValue);
                          #endif
                    #endif

                    #if _BASETINTCOLOR_ON
                        _Mask_var.rgb *= _BaseTintColor.rgb;
                    #endif
                #endif
                ...
                fixed3 finalColor = _Mask_var;// float3(0, 0, 0);
                    ...
                    fixed3 effect1Color;
                    half2 effect1MaskUV;
                    #if defined(_EFFECT1USEMASKUV_ON)
                    effect1MaskUV = i.uv4.zw;
                    #else
                    effect1MaskUV = i.uv4.xy;
                    #endif
                        ...
                        #if _EFFECT1USEGLOW_ON
                        i.Glowcolor1.x = cos((effectTime1 * _Effect1GlowSpeed)) * 0.5 + 0.5;
                        #endif
                    #endif
                    ...
                    #if defined(_EFFECT1USEMASK_ON)// || defined(_EFFECT1USEDISTORTMASK_ON)
                        #if _EFFECT1USEDISTORTMASK_ON
                        fixed2 _Effect1_mask = tex2D(_Effect1Mask, effect1MaskUV).rg;
                        i.uv0.zw += ((_Effect1_mask.g - 0.5) * 2) * _Effect1MaskDistortStrength;
                        #else
                        fixed _Effect1_mask = tex2D(_Effect1Mask, effect1MaskUV).r;
                        #endif
                    #endif
                                ...
                                half2 effect1TimerMaskUV;
                                    #if defined(_EFFECT1USETIMERMASKBASEUV_ON)
                                    effect1TimerMaskUV = effect1MaskUV;
                                    #else
                                    effect1TimerMaskUV = i.uv0.zw;
                                    #endif
                    ...
                    #if _EFFECT1USELUMINANCEMASK_ON
                        effect1Color *= _SpriteLuminanceMask;
                    #endif
                    #if _EFFECT1USEGLOW_ON
                        effect1Color *= i.Glowcolor1.x;
                    #endif
                    #if defined(_EFFECT1BLENDMASK_ON) //defined(_EFFECT2USEDISTORTMASK_ON) && 
                        effect2Mask.g = saturate(effect1Color.g);
                    #endif
                    #if _EFFECT1USEMASK_ON
                        effect1Color *= _Effect1_mask.r;
                    #endif
                    #if _EFFECT1BLENDMASK_ON
                        effect2Mask.r = effect1Color.r;
                        effect2Mask = saturate(effect2Mask);
 
                        #elif _EFFECT1ALPHABLEND_ON
                            #if _EFFECT1USEALPHA_ON
                                fixed effect1Alpha = _Effect1_var.a;
                                #else
                                fixed effect1Alpha = saturate(Luminance(_Effect1_var)*4);
                            #endif
                            #if _EFFECT1USEGLOW_ON
                                effect1Alpha *= i.Glowcolor1.x;
                            #endif
                            ...
                            #endif
                            finalColor = lerp(finalColor,effect1Color, effect1Alpha);
                        #else
                        finalColor += effect1Color;
                        #if _REMOVEBASESPRITE_ON
                    ...
                    fixed3 effect2Color;
                    half2 effect2MaskUV;
                    #if defined(_EFFECT2USEMASKUV_ON)
                    effect2MaskUV = i.uv4.zw;
                    #else
                    effect2MaskUV = i.uv4.xy;
                    #endif
                        ...
                        #if _EFFECT2USEGLOW_ON
				        i.Glowcolor1.y = cos((effectTime2 *_Effect2GlowSpeed))*0.5 + 0.5;
                        #endif
                    #endif
                        ...
                        #if _EFFECT2USEDISTORTMASK_ON
                            #if _EFFECT2USEMASK_ON
                                fixed2 _Effect2_mask = tex2D(_Effect2Mask, effect2MaskUV).rg;
                                i.uv1.xy += (((_Effect2_mask.g * effect2Mask.g) - 0.5) * 2)* _Effect2MaskDistortStrength;
                            #else
                                i.uv1.xy += ((effect2Mask.g - 0.5) * 2) * _Effect2MaskDistortStrength;
                            #endif
                        #else
                        fixed _Effect2_mask = tex2D(_Effect2Mask, effect2MaskUV).r;
                        #endif
                    #endif
                                ...
                                fixed4 _Effect2_var = ScaleCurveTexBlend(_Effect2Tex, i.uv1.xy, _Effect2ScaleOrigin, _Effect2ScaleSpeed, _Effect2ScaleCurve, _Effect2FlipbookValue);
                                    ...
                                    #if defined(_EFFECT2USETIMERMASKBASEUV_ON)
                                    effect2TimerMaskUV = effect2MaskUV;
                                    #else
                                    effect2TimerMaskUV = i.uv1.xy;
                                    #endif
                    ...
                    #if _EFFECT2USELUMINANCEMASK_ON
                        effect2Color *= _SpriteLuminanceMask;
                    #endif
                    #if _EFFECT2USEGLOW_ON
                        effect2Color *= i.Glowcolor1.y;
                    #endif
                    #if defined(_EFFECT2BLENDMASK_ON)//defined(_EFFECT3USEDISTORTMASK_ON) && 
                        effect3Mask.g *= saturate(effect2Color.g) * effect2Mask.g;
                    #endif
                    #if _EFFECT2USEMASK_ON                    
                        effect2Color *= _Effect2_mask.r;
                    #endif
                    #if _EFFECT2BLENDMASK_ON
                        effect3Mask.r *= effect2Color.r;
                        effect3Mask = saturate(effect3Mask);
                        #elif _EFFECT2ALPHABLEND_ON
                            #if _EFFECT2USEALPHA_ON
                                fixed effect2Alpha = _Effect2_var.a;
                                #else
                                fixed effect2Alpha = saturate(Luminance(_Effect2_var)*4);
                            #endif
                            #if _EFFECT2USEGLOW_ON
                                effect2Alpha *= i.Glowcolor1.y;
                            #endif
                            ...
                            #endif
                            finalColor = lerp(finalColor,effect2Color, effect2Alpha * effect2Mask.r);
                        #else
                        finalColor += effect2Color;
                        #if _REMOVEBASESPRITE_ON
                    ...
                    fixed3 effect3Color;
                    half2 effect3MaskUV;
                    #if defined(_EFFECT3USEMASKUV_ON)
                    effect3MaskUV = i.uv4.zw;
                    #else
                    effect3MaskUV = i.uv4.xy;
                    #endif
                        ...
                        #if _EFFECT3USEGLOW_ON
				        i.Glowcolor1.z = cos((effectTime3 *_Effect3GlowSpeed))*0.5 + 0.5;
                        #endif
                    #endif
                        ...
                        #if _EFFECT3USEDISTORTMASK_ON
                            #if _EFFECT3USEMASK_ON
                                fixed2 _Effect3_mask = tex2D(_Effect3Mask, effect3MaskUV).rg;
                                i.uv1.zw += (((_Effect3_mask.g * effect3Mask.g) - 0.5) * 2) * _Effect3MaskDistortStrength;
                            #else
                                i.uv1.zw += ((effect3Mask.g - 0.5) * 2) * _Effect3MaskDistortStrength;
                            #endif
                        #else
                        fixed _Effect3_mask = tex2D(_Effect3Mask, effect3MaskUV).r;
                        #endif
                    #endif
                                ...
                                fixed4 _Effect3_var = ScaleCurveTexBlend(_Effect3Tex, i.uv1.zw, _Effect3ScaleOrigin, _Effect3ScaleSpeed, _Effect3ScaleCurve, _Effect3FlipbookValue);
                                    ...
                                    #if defined(_EFFECT3USETIMERMASKBASEUV_ON)
                                    effect3TimerMaskUV = effect3MaskUV; 
                                    #else
                                    effect3TimerMaskUV = i.uv1.zw;
                                    #endif
                    ...
                    #if _EFFECT3USELUMINANCEMASK_ON
                        effect3Color *= _SpriteLuminanceMask;
                    #endif
                    #if _EFFECT3USEGLOW_ON
                        effect3Color *= i.Glowcolor1.z;
                    #endif
                    #if defined(_EFFECT3BLENDMASK_ON)//defined(_EFFECT4USEDISTORTMASK_ON) && 
                        effect4Mask.g *= saturate(effect3Color.g)* effect3Mask.g;
                    #endif
                    #if _EFFECT3USEMASK_ON
                        effect3Color *= _Effect3_mask.r;
                    #endif
                    #if _EFFECT3BLENDMASK_ON
                        effect4Mask.r *= effect3Color.r;
                        effect4Mask = saturate(effect4Mask);
                        #elif _EFFECT3ALPHABLEND_ON
                            #if _EFFECT3USEALPHA_ON
                                fixed effect3Alpha = _Effect3_var.a;
                                #else
                                fixed effect3Alpha = saturate(Luminance(_Effect3_var)*4);
                            #endif
                            #if _EFFECT3USEGLOW_ON
                                effect3Alpha *= i.Glowcolor1.z;
                            #endif
                            ...
                            #endif
                            finalColor = lerp(finalColor,effect3Color, effect3Alpha * effect3Mask.r);
                        #else
                        finalColor += effect3Color;
                        #if _REMOVEBASESPRITE_ON
                    ...
                    fixed3 effect4Color;
                    half2 effect4MaskUV;
                    #if defined(_EFFECT4USEMASKUV_ON)
                    effect4MaskUV = i.uv4.zw;
                    #else
                    effect4MaskUV = i.uv4.xy;
                    #endif
                        ...
                        #if _EFFECT4USEGLOW_ON
				        i.Glowcolor1.w = cos((effectTime4 *_Effect4GlowSpeed))*0.5 + 0.5;
                        #endif
                    #endif
                        ...
                        #if _EFFECT4USEDISTORTMASK_ON
                            #if _EFFECT4USEMASK_ON
                                fixed2 _Effect4_mask = tex2D(_Effect4Mask, effect4MaskUV).rg;
                                i.uv2.xy += (((_Effect4_mask.g * effect4Mask.g) - 0.5) * 2) * _Effect4MaskDistortStrength;
                            #else
                                i.uv2.xy += ((effect4Mask.g - 0.5) * 2) * _Effect4MaskDistortStrength;
                            #endif
                        #else
                        fixed _Effect4_mask = tex2D(_Effect4Mask, effect4MaskUV).r;
                        #endif
                    #endif
                                ...
                                half2 effect4TimerMaskUV;
                                    #if defined(_EFFECT4USETIMERMASKBASEUV_ON)
                                    effect4TimerMaskUV = effect4MaskUV; 
                                    #else
                                    effect4TimerMaskUV = i.uv2.xy;
                                    #endif
                    ...
                    #if _EFFECT4USELUMINANCEMASK_ON
                        effect4Color *= _SpriteLuminanceMask;
                    #endif
                    #if _EFFECT4USEGLOW_ON
                        effect4Color *= i.Glowcolor1.w;
                    #endif
                    #if defined(_EFFECT4BLENDMASK_ON)//defined(_EFFECT5USEDISTORTMASK_ON) && 
                        effect5Mask.g *= saturate(effect4Color.g) * effect4Mask.g;;
                    #endif
                    #if _EFFECT4USEMASK_ON
                        effect4Color *= _Effect4_mask.r;
                    #endif

                    #if _EFFECT4BLENDMASK_ON
                        effect5Mask.r *= effect4Color.r;
                        effect5Mask = saturate(effect5Mask);
                        #elif _EFFECT4ALPHABLEND_ON
                            #if _EFFECT4USEALPHA_ON
                                fixed effect4Alpha = _Effect4_var.a;
                                #else
                                fixed effect4Alpha = saturate(Luminance(_Effect4_var)*4);
                            #endif
                            #if _EFFECT4USEGLOW_ON
                                effect4Alpha *= i.Glowcolor1.w;
                            #endif
                            ...
                            #endif
                            finalColor = lerp(finalColor,effect4Color, effect4Alpha * effect4Mask.r);
                        #else
                        finalColor += effect4Color;
                        #if _REMOVEBASESPRITE_ON
                    ...
                    fixed3 effect5Color;
                    half2 effect5MaskUV;
                    #if defined(_EFFECT5USEMASKUV_ON)
                    effect5MaskUV = i.uv4.zw;
                    #else
                    effect5MaskUV = i.uv4.xy;
                    #endif
                        ...
                        #if _EFFECT5USEGLOW_ON
				        i.Glowcolor2.x = cos((effectTime5 *_Effect5GlowSpeed))*0.5 + 0.5;
                        #endif
                    #endif
                        ...
                        #if _EFFECT5USEDISTORTMASK_ON
                            #if _EFFECT5USEMASK_ON
                                fixed2 _Effect5_mask = tex2D(_Effect5Mask, effect5MaskUV).rg;
                                i.uv2.zw += (((_Effect5_mask.g * effect5Mask.g) - 0.5) * 2) * _Effect5MaskDistortStrength;
                            #else
                                i.uv2.zw += ((effect5Mask.g - 0.5) * 2) * _Effect5MaskDistortStrength;
                            #endif
                        #else
                        fixed _Effect5_mask = tex2D(_Effect5Mask, effect5MaskUV).r;
                        #endif
                    #endif
                                ...
                                half2 effect5TimerMaskUV;
                                    #if defined(_EFFECT5USETIMERMASKBASEUV_ON)
                                    effect5TimerMaskUV = effect5MaskUV;
                                    #else
                                    effect5TimerMaskUV = i.uv2.zw;
                                    #endif
                    ...
                    #if _EFFECT5USELUMINANCEMASK_ON
                        effect5Color *= _SpriteLuminanceMask;
                    #endif
                    #if _EFFECT5USEGLOW_ON
                        effect5Color *= i.Glowcolor2.x;
                    #endif
                    #if defined(_EFFECT5BLENDMASK_ON)//defined(_EFFECT6USEDISTORTMASK_ON) && 
                        effect6Mask.g *= saturate(effect5Color.g) * effect5Mask.g;;
                    #endif
                    #if _EFFECT5USEMASK_ON                        
                        effect5Color *= _Effect5_mask.r;
                    #endif
                    #if _EFFECT5BLENDMASK_ON
                        effect6Mask.r *= effect5Color.r;
                        effect6Mask = saturate(effect6Mask);
                        #elif _EFFECT5ALPHABLEND_ON
                            #if _EFFECT5USEALPHA_ON
                                fixed effect5Alpha = _Effect5_var.a;
                                #else
                                fixed effect5Alpha = saturate(Luminance(_Effect5_var)*4);
                            #endif
                            #if _EFFECT5USEGLOW_ON
                                effect5Alpha *= i.Glowcolor2.x;
                            #endif
                            ...
                            #endif
                            finalColor = lerp(finalColor,effect5Color, effect5Alpha * effect5Mask.r);
                        #else
                        finalColor += effect5Color;
                        #if _REMOVEBASESPRITE_ON
                    ...
                    fixed3 effect6Color;
                    half2 effect6MaskUV;
                    //#if defined(_EFFECT6USEMASKUV_ON)
                    //effect6MaskUV = i.uv4.zw;
                    //#else
                    //effect6MaskUV = i.uv4.xy;
                    //#endif
                    effect6MaskUV = _Effect6UseMaskUV ? i.uv4.zw : i.uv4.xy;
                        ...
                        #if _EFFECT6USEGLOW_ON
				        i.Glowcolor2.y = cos((effectTime6 *_Effect6GlowSpeed))*0.5 + 0.5;
                        #endif
                    #endif
                        ...
                        //#if _EFFECT6USEDISTORTMASK_ON
                        //    #if _EFFECT6USEMASK_ON
                        //        fixed2 _Effect6_mask = tex2D(_Effect6Mask, effect6MaskUV).rg;
                        //        i.uv3.xy += (((_Effect6_mask.g * effect6Mask.g) - 0.5) * 2) * _Effect6MaskDistortStrength;
                        //    #else
                        //        i.uv3.xy += ((effect6Mask.g - 0.5) * 2) * _Effect6MaskDistortStrength * 0.2;
                        //    #endif
                        //#else
                        //fixed _Effect6_mask = tex2D(_Effect6Mask, effect6MaskUV).r;
                        //#endif
                        #if _EFFECT6USEMASK_ON
                            i.uv3.xy += _Effect6UseDistortMask ? (((tex2D(_Effect6Mask, effect6MaskUV).g * effect6Mask.g) - 0.5) * 2) * _Effect6MaskDistortStrength : 0;
                        #else
                        ...
                        fixed _Effect6_mask = tex2D(_Effect6Mask, effect6MaskUV).r;
                                ...
                                effect6TimerMaskUV = _Effect6UseTimerMaskBaseUV ? effect6MaskUV : i.uv3.xy;
                                    //#if defined(_EFFECT6USETIMERMASKBASEUV_ON)
                                    //effect6TimerMaskUV = effect6MaskUV; 
                                    //#else
                                    //effect6TimerMaskUV = i.uv3.xy;
                                    //#endif
